...
{ PROC_LINKS(kv_list_all_locations, 0), false, "kv_list_all_locations", 21, "adapted from list_all_locations for fuzzy search, if cursor at identifier then search for that instead", 102, "G:\\projects\\4ed\\code\\custom\\4coder_search.cpp", 45, 876 },
