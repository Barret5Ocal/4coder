...
TokenCppKind_f32 = 157,
TokenCppKind_u32 = 158,
TokenCppKind_u16 = 159,
TokenCppKind_i32 = 160,
TokenCppKind_i16 = 161,
TokenCppKind_i8 = 162,
TokenCppKind_string = 163,
TokenCppKind_cstring = 164,
TokenCppKind_rawptr = 165,
TokenCppKind_nil = 166,
TokenCppKind_u8 = 167,
TokenCppKind_byte = 168,
TokenCppKind_any = 169,
TokenCppKind_package = 170,
TokenCppKind_import = 171,
TokenCppKind_foreign = 172,
TokenCppKind_when = 173,
TokenCppKind_defer = 174,
TokenCppKind_in = 175,
TokenCppKind_not_in = 176,
TokenCppKind_fallthrough = 177,
TokenCppKind_proc = 178,
TokenCppKind_bit_field = 179,
TokenCppKind_bit_set = 180,
TokenCppKind_map = 181,
TokenCppKind_dynamic = 182,
TokenCppKind_cast = 183,
TokenCppKind_auto_cast = 184,
TokenCppKind_transmute = 185,
TokenCppKind_no_inline = 186,
TokenCppKind_context = 187,
TokenCppKind_size_of = 188,
TokenCppKind_align_of = 189,
TokenCppKind_offset_of = 190,
TokenCppKind_type_of = 191,
TokenCppKind_distinct = 192,
TokenCppKind_opaque = 193,
TokenCppKind_LiteralTrue = 194,
TokenCppKind_LiteralFalse = 195,
TokenCppKind_Identifier = 196,
TokenCppKind_PPInclude = 197,
TokenCppKind_PPVersion = 198,
TokenCppKind_PPDefine = 199,
TokenCppKind_PPUndef = 200,
TokenCppKind_PPIf = 201,
TokenCppKind_PPIfDef = 202,
TokenCppKind_PPIfNDef = 203,
TokenCppKind_PPElse = 204,
TokenCppKind_PPElIf = 205,
TokenCppKind_PPEndIf = 206,
TokenCppKind_PPError = 207,
TokenCppKind_PPImport = 208,
TokenCppKind_PPUsing = 209,
TokenCppKind_PPLine = 210,
TokenCppKind_PPPragma = 211,
TokenCppKind_PPUnknown = 212,
TokenCppKind_PPDefined = 213,
TokenCppKind_COUNT = 214,
};
